...
<a href="<?= base_url('admin/accounts/create') ?>" class="inline-block bg-red-600 hover:bg-red-700 mb-4 px-4 py-2 rounded text-white">
    + Add User
</a>
            ...
            <?php foreach ($users as $u): ?>
                <tr class="border-gray-300 dark:border-gray-700 border-t">
                    ...
                    <td class="flex gap-2 px-4 py-2">
                        <!-- Edit button -->
                        <a href="<?= base_url('admin/accounts/edit/' . $u['id']) ?>"
                            class="bg-yellow-500 hover:bg-yellow-600 px-2 py-1 rounded text-white">Edit</a>

                        <!-- Delete button -->
                        <form action="<?= site_url('/admin/accounts/delete/' . $u['id']) ?>" method="post" onsubmit="return confirm('Delete this user?');">
